...
EOS
    ...
    it 'plain single line' do
      s1 = 'attr_accessor :address = "1313 Mockingbird Lane", attr_accessor :name = "Herman Munster"'
    ...
    it 'colored multiline (default)' do
      s1 = <<-EOS.strip
    \e[1;36mattr_accessor\e[0m \e[0;35m:address\e[0m\e[0;37m = \e[0m\e[0;33m\"1313 Mockingbird Lane\"\e[0m,\n
EOS
      s2 = <<-EOS.strip
    \e[1;36mattr_accessor\e[0m \e[0;35m:address\e[0m\e[0;37m = \e[0m\e[0;33m\"1313 Mockingbird Lane\"\e[0m,\n
EOS
